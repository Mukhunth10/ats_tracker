...
INSERT INTO "new_Assessment" ("applicationId", "candidateNote", "createdAt", "durationMin", "id", "instructions", "outputUrl", "qualityScore", "reviewNotes", "reviewedAt", "sentAt", "status", "submittedAt", "testUrl", "title", "token", "videoUrl") SELECT "applicationId", "candidateNote", "createdAt", "durationMin", "id", "instructions", "outputUrl", "qualityScore", "reviewNotes", "reviewedAt", "sentAt", "status", "submittedAt", "testUrl", "title", "token", "videoUrl" FROM "Assessment";
