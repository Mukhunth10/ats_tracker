...
INSERT INTO "new_Assessment" ("applicationId", "attentionAwaySec", "attentionEvents", "candidateNote", "consentAt", "consentCamera", "consentNoticeVersion", "consentScreen", "createdAt", "durationMin", "id", "instructions", "outputUrl", "qualityScore", "reviewNotes", "reviewedAt", "sentAt", "status", "submittedAt", "testUrl", "title", "token", "videoUrl") SELECT "applicationId", "attentionAwaySec", "attentionEvents", "candidateNote", "consentAt", "consentCamera", "consentNoticeVersion", "consentScreen", "createdAt", "durationMin", "id", "instructions", "outputUrl", "qualityScore", "reviewNotes", "reviewedAt", "sentAt", "status", "submittedAt", "testUrl", "title", "token", "videoUrl" FROM "Assessment";
